                        ...
                        <div className="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                            ...
                            <div className="row">
                                <div className="col-lg-6">
                                    <ul>
                                        <li><i className="bi bi-chevron-right" /> <strong>Birthday:</strong> <span>1 May 2002</span></li>
                                        <li><i className="bi bi-chevron-right" /> <strong>Website:</strong> <span>www.example.com</span></li>
                                        <li><i className="bi bi-chevron-right" /> <strong>Phone:</strong> <span>0326869406</span></li>
                                        <li><i className="bi bi-chevron-right" /> <strong>City:</strong> <span>VietNam</span></li>
                                    </ul>
                                </div>
                                <div className="col-lg-6">
                                    <ul>
                                        ...
                                        <li><i className="bi bi-chevron-right" /> <strong>PhEmailone:</strong> <span>tramnvph14967@gmail.com</span>
                                        </li>
